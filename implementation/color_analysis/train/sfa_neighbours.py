...
class SfaComponentExtractor:
    def __init__(self, path_positive_images, path_negative_images, color_space):
    ...
    def extract_skin_pixels(self):
        ...
        skin_images = utils.load_images_from_folder(self.path_positive_images)
    ...
    def extract_non_skin_pixels(self):
        ...
        non_skin_images = utils.load_images_from_folder(self.path_negative_images)
