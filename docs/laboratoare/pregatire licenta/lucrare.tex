...
\begin{document}
	...
	\chapter{Introduction \todo{rewrite section}}
	...
	\subsubsection{Texture analysis} \todo{expand}
	Finally, a Support Vector Machine analyzes patches around each pixel and calculates Haralick features in order to classify the texture. The results from color and texture detection are then combined into the final result.
	
	\subsubsection{The final image} \todo{expand}
	...
	\chapter{Conclusions} \todo{write section}
