...
\begin{document}
	...
	\tableofcontents
	\listoffigures \todo{rename figures}
	\listoftables
	\newpage
	
	\chapter{Introduction \todo{rename this or the other}}
	
	\section{Introduction} \todo{remove first person}
	...
	\todo{some kind of introduction in the topic?}
	...
	\subsection{Overview}
	The model proposed by this paper is made up of three steps and was designed to combine the most efficient detectors in all aspects of skin detection. There is a preprocessing step that is applied to all images, namely a resize operation to the (200, 200) dimension, with the purpose of reducing computation time.
	...
	\subsubsection{Detection examples}
	\begin{figure}[h!]
		\centering
	...
	I have only used a subset of 50 images for evaluation due to its computation time, while most models use from 2000 to 6000 images. The images selected for my model could have been not very representative for the dataset.
