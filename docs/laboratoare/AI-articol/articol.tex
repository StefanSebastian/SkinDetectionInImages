...
\begin{document}
	...
	\section{Conclusions}
	The model obtains results similar to the ones presented in literature however image segmentation and analyzing probabilities for every pixel's neighbors take a toll on computation speed.
