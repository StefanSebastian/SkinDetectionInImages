...
\begin{document}
	...
	\subsection{Overview} \todo{add diagram somewhere}
	...
	\begin{table}[h!]
		\begin{center}
			...
			\begin{tabular}{c | c|c|c}
				...
				TPR 	  & 0.828 & 0.817 & a \\
				FPR 	  & 0.227 & 0.216 & b \\
				Accuracy  & 0.933 & 0.927 & c \\
				Precision & 0.506 & 0.515 & 1 \\
			\end{tabular}
		\end{center}
	\end{table}
	...
	\chapter{User manual} \todo{mention different proc; multiple ops at the same time}
	\section{Introduction}
