...
\begin{document}
	...
	Relying on the assumption that gray-tone arrangement can describe texture, Haralick et al. defined a set of 14 measures of textural features as functions over the normalized, symmetric form of the GLCM.
	
	
	
	\todo{mention that this technique can measure coarseness roughness and directionality in one calculation?}
	\todo{mention about the directions and how usually only one is chosen?}
